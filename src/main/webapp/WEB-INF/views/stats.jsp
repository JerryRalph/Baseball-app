...
<body>
	...
	<div class="sidenav">
		...
		<br> <a href="${context}/baseball/schedule"><i class="fa fa-calendar" aria-hidden="true"></i>Tournament
			Schedule </a> 
			<br>
			<a href="${context}/baseball/roster"><i class="fa fa-home "> Team Roster</i></a><br>
	</div>
	...
	<form:form method="post" modelAttribute="baseball"
		...
		<ul class="color2">
			...
			<li>At Bats: <c:out value="${baseball.atBats}" /></li>

			<li>Hits: <c:out value="${baseball.hits}" /></li>

			<li>Average: <c:out value="${baseball.average}" /></li>
